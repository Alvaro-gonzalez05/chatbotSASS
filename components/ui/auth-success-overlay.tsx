...
export default function AuthSuccessOverlay({
  ...
  useEffect(() => {
    ...
    const steps = [
      ...
      { delay: 1300, duration: 600 },  // Check animado
      { delay: 2000, duration: 600 },  // Mensaje de bienvenida
      { delay: 2800, duration: 400 },  // Información del usuario
      { delay: 3400, duration: 600 },  // Preparando redirección
    ]
