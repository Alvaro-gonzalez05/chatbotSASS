...
-- Products table (only appears if bot has 'take_orders' feature)
...
-- Orders table (only appears if bot has 'take_orders' feature)
...
-- Reservations table (only appears if bot has 'take_reservations' feature)
